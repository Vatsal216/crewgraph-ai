...
class DocumentationGenerator:
    ...
    def generate_documentation(
        ...
        with self._lock:
            ...
            if doc_type == DocumentationType.USER_MANUAL:
                doc_sections = self._generate_user_manual(
                    workflow_def, workflow_description, include_examples
                )
            elif doc_type == DocumentationType.TECHNICAL_SPECS:
                doc_sections = self._generate_technical_specs(
                    workflow_def, workflow_description, include_diagrams
                )
                ...
                doc_sections = self._generate_tutorial(
                    workflow_def, workflow_description, include_examples
                )
                ...
                doc_sections = self._generate_generic_documentation(
                    workflow_def, workflow_description
                )
    ...
    def generate_workflow_documentation(
        ...
        dependencies_diagram = self._create_dependencies_diagram(
            workflow_definition.get("tasks", []), workflow_definition.get("dependencies", [])
        )
        ...
        troubleshooting = self._generate_troubleshooting_guide(
            workflow_definition, execution_history
        )
    ...
    def _generate_overview(self, workflow_definition: Dict[str, Any]) -> str:
        ...
        if task_count == 0:
            ...
            return (
                f"This workflow executes {task_count} tasks in sequence, "
    ...
    def _create_dependencies_diagram(
        self, tasks: List[Dict[str, Any]], dependencies: List[Dict[str, str]]
    ) -> str:
    ...
    def _generate_user_manual(
        self, workflow_def: Dict[str, Any], description: str, include_examples: bool
    ...
    def _generate_troubleshooting_guide(
        self, workflow_definition: Dict[str, Any], execution_history: Optional[List[Dict[str, Any]]]
    ) -> List[str]:
        """Generate troubleshooting guide."""
        troubleshooting = []
    ...
    def _generate_performance_notes(
        self, execution_history: Optional[List[Dict[str, Any]]]
    ) -> List[str]:
        ...
        execution_times = [
            h.get("execution_time", 0) for h in execution_history if h.get("execution_time")
        ]
        if execution_times:
...
- Contact support with workflow definitions and error logs"""
    ...
    def _compile_documentation(
        self, sections: List[DocumentationSection], doc_type: DocumentationType
    ) -> str:
...
"""
    ...
    def _generate_technical_specs(
        self, workflow_def: Dict[str, Any], description: str, include_diagrams: bool
    ) -> List[DocumentationSection]:
    ...
    def _generate_api_reference(
        self, workflow_def: Dict[str, Any], description: str
    ) -> List[DocumentationSection]:
    ...
    def get_generation_statistics(self) -> Dict[str, Any]:
        ...
        avg_generation_time = (
            sum(g["generation_time"] for g in self._generation_history) / total_generations
        )
        avg_doc_length = (
            sum(g["documentation_length"] for g in self._generation_history) / total_generations
        )
...
class CodeGenerator:
    ...
    def generate_code(
        ...
        with self._lock:
            ...
            main_file = self._generate_main_implementation(
                workflow_def, language, include_documentation
            )
    ...
    def _generate_main_implementation(
        self, workflow_def: Dict[str, Any], language: CodeLanguage, include_documentation: bool
    ) -> GeneratedCode:
    ...
    def _generate_python_implementation(
        self, workflow_def: Dict[str, Any], include_documentation: bool
    ) -> GeneratedCode:
    ...
    def _generate_crewai_python_code(
        self, workflow_def: Dict[str, Any], include_documentation: bool
    ) -> str:
    ...
    def _generate_generic_python_code(
        self, workflow_def: Dict[str, Any], include_documentation: bool
    ) -> str:
    ...
    def _generate_configuration_files(
        self, workflow_def: Dict[str, Any], language: CodeLanguage
    ) -> List[GeneratedCode]:
        """Generate configuration files"""
    ...
    def _generate_javascript_implementation(
        self, workflow_def: Dict[str, Any], include_documentation: bool
    ) -> GeneratedCode:
...
export async function runWorkflow(inputs: WorkflowInput | null = null): Promise<WorkflowResult> {{
    ...
    def _generate_generic_implementation(
        self, workflow_def: Dict[str, Any], language: CodeLanguage, include_documentation: bool
    ) -> GeneratedCode:
...
function run_workflow(inputs) {{
    ...
    def _generate_langgraph_python_code(
        self, workflow_def: Dict[str, Any], include_documentation: bool
    ) -> str:
