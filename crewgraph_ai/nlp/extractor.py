...
class TaskExtractor:
    ...
    def _clean_task_description(self, sentence: str) -> str:
        ...
        prefixes = ["first", "then", "next", "after that", "finally", "we need to", "should", "must"]
    ...
    def _classify_task_type(self, sentence: str) -> str:
        ...
        type_keywords = {
            ...
            "io": ["read", "write", "save", "load", "fetch", "download", "upload", "export", "import"],
    ...
    def _initialize_action_verbs(self) -> List[str]:
        ...
        return [
            "analyze", "process", "create", "generate", "send", "receive",
            "transform", "convert", "validate", "verify", "check", "test",
            "save", "load", "read", "write", "update", "modify", "delete",
            "calculate", "compute", "evaluate", "assess", "review", "examine",
            "collect", "gather", "fetch", "download", "upload", "export",
            "import", "sync", "merge", "combine", "split", "filter", "sort",
            "monitor", "track", "watch", "log", "notify", "alert", "schedule"
        ]
