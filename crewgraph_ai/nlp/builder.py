...
from .parser import RequirementsParser, WorkflowParser, ParsedWorkflow
...
class ConversationalWorkflowBuilder:
    ...
    def start_conversation(self, session_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "next_question": session.pending_questions[0].question if session.pending_questions else None,
    ...
    def _process_requirements_input(self, session: ConversationSession, user_input: str) -> Dict[str, Any]:
    ...
    def _process_task_clarification(self, session: ConversationSession, user_input: str) -> Dict[str, Any]:
    ...
    def _process_agent_definition(self, session: ConversationSession, user_input: str) -> Dict[str, Any]:
    ...
    def _process_dependency_input(self, session: ConversationSession, user_input: str) -> Dict[str, Any]:
    ...
    def _process_workflow_review(self, session: ConversationSession, user_input: str) -> Dict[str, Any]:
    ...
    def _process_finalization(self, session: ConversationSession, user_input: str) -> Dict[str, Any]:
    ...
    def _generate_task_clarification_questions(self, workflow_data: Dict[str, Any]) -> List[WorkflowQuestion]:
        ...
        if objectives:
            for i, objective in enumerate(objectives):
                questions.append(WorkflowQuestion(
    ...
    def _generate_agent_definition_questions(self, workflow_data: Dict[str, Any]) -> List[WorkflowQuestion]:
    ...
    def _generate_dependency_questions(self, workflow_data: Dict[str, Any]) -> List[WorkflowQuestion]:
    ...
    def _process_task_answer(self, session: ConversationSession, question: WorkflowQuestion, answer: str):
    ...
    def _process_agent_answer(self, session: ConversationSession, question: WorkflowQuestion, answer: str):
    ...
    def _process_dependency_answer(self, session: ConversationSession, question: WorkflowQuestion, answer: str):
    ...
    def _process_workflow_modifications(self, session: ConversationSession, modification_request: str):
