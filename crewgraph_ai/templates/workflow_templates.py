...
class WorkflowTemplate(ABC):
    ...
    def create_workflow(
        self, params: Dict[str, Any], workflow_name: Optional[str] = None
    ) -> GraphOrchestrator:
        """
    ...
    def get_parameter_schema(self) -> Dict[str, Any]:
        ...
        for param in self.parameters:
            param_schema = {"type": param.param_type, "description": param.description}
...
class TemplateRegistry:
    ...
    def list_templates(
        self, category: Optional[TemplateCategory] = None, tags: Optional[List[str]] = None
    ) -> List[str]:
        """
    ...
    def search_templates(self, query: str) -> List[str]:
        ...
        for name, template in self._templates.items():
            if (
                ...
                or any(query in tag.lower() for tag in template.metadata.tags)
            ):
                results.append(name)
...
def create_workflow_from_template(
    template_name: str, params: Dict[str, Any], workflow_name: Optional[str] = None
) -> GraphOrchestrator:
    """
