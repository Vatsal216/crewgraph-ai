...
from ..utils.metrics import PerformanceMonitor, get_metrics_collector
...
class CrewGraph:
    ...
    def add_agent(self, agent: Agent, name: str) -> None:
        ...
        metrics.increment_counter(
            ...
            labels={"workflow_name": self.name, "agent_name": name, "created_by": "Vatsal216"},
        )
    ...
    def add_task(
        self, name: str, description: str, agent: str, dependencies: Optional[List[str]] = None
    ) -> Task:
        ...
        # Create CrewAI task
        task = Task(description=description, agent=self.agents[agent])
    ...
    def add_tool(self, name: str, func, description: str) -> Tool:
        ...
        metrics.increment_counter(
            ...
            labels={"workflow_name": self.name, "tool_name": name, "created_by": "Vatsal216"},
        )
    ...
    def execute(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        metrics.increment_counter(
            ...
            labels={"workflow_name": self.name, "execution_id": execution_id, "user": "Vatsal216"},
        )
        ...
        try:
            with performance_monitor.track_execution(execution_id):
                ...
                crew = Crew(
                    agents=list(self.agents.values()), tasks=list(self.tasks.values()), verbose=True
                )
                ...
                metrics.record_duration(
                    ...
                    execution_time,
                    labels={"workflow_name": self.name, "status": "success", "user": "Vatsal216"},
                )
