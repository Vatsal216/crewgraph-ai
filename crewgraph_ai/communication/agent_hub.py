...
class AgentCommunicationHub:
    ...
    def __init__(
        ...
        logger.info(
            f"Max message history: {max_message_history}, Cleanup interval: {cleanup_interval}s"
        )
            ...
            if other_agent_id:
                ...
                if (
                    ...
                    or (
                        ...
                        and agent_id in self._channels[message.channel].subscribers
                    )
                ):
                    messages.append(message)
    ...
    def get_hub_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "active_channels": [
                name for name, channel in self._channels.items() if channel.subscribers
            ],
