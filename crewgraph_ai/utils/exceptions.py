...
class ValidationError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message, error_code="VALIDATION_ERROR", details=details, suggestions=suggestions
        )
...
class ExecutionError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message, error_code="EXECUTION_ERROR", details=details, suggestions=suggestions
        )
...
class ConfigurationError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message, error_code="CONFIGURATION_ERROR", details=details, suggestions=suggestions
        )
...
class MemoryError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message, error_code="MEMORY_ERROR", details=details, suggestions=suggestions
        )
...
class PlanningError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message, error_code="PLANNING_ERROR", details=details, suggestions=suggestions
        )
...
class ToolError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(message, error_code="TOOL_ERROR", details=details, suggestions=suggestions)
...
class AgentError(CrewGraphError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message, error_code="AGENT_ERROR", details=details, suggestions=suggestions
        )
