...
class ParameterValidator:
    ...
    def _setup_default_rules(self):
        ...
        # String validations
        self.add_rule("string", ValidationRule(
            name="string_type",
        ...
        self.add_rule("non_empty_string", ValidationRule(
            name="non_empty",
        ...
        self.add_rule("positive_integer", ValidationRule(
            name="positive",
        ...
        self.add_rule("list", ValidationRule(
            name="list_type",
            validation_type=ValidationType.TYPE,
        ...
        self.add_rule("dict", ValidationRule(
            name="dict_type",
            validation_type=ValidationType.TYPE,
        ...
        self.add_rule("json", ValidationRule(
            name="json_format",
            validation_type=ValidationType.FORMAT,
    ...
    def validate_parameter(self, 
                         ...
                         custom_rules: Optional[List[ValidationRule]] = None) -> bool:
        """
        ...
        for rule in all_rules:
            try:
                ...
                error_msg = f"Parameter '{parameter_name}': Validation rule '{rule.name}' failed - {str(e)}"
    ...
    def validate_parameters(self, 
                          ...
                          schema: Dict[str, str],
                          custom_rules: Optional[Dict[str, List[ValidationRule]]] = None) -> bool:
        """
        ...
        if all_errors:
            raise ValidationError(
                "Multiple parameter validation errors",
    ...
    def create_range_rule(self, 
                         ...
                         inclusive: bool = True) -> ValidationRule:
