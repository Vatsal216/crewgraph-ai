...
class BaseMemory(ABC):
    ...
    def append_message_to_conversation(self, 
                                     conversation_id: str, 
    ...
    def get_conversation_summary(self, conversation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            conversation_duration = (max(timestamps) - min(timestamps)) if len(timestamps) > 1 else 0
    ...
    def _extract_conversation_topics(self, messages: List[BaseMessage]) -> List[str]:
        ...
        try:
            common_topics = [
                'strategy', 'analysis', 'research', 'technology', 'business',
                'ai', 'machine learning', 'data', 'innovation', 'planning',
                'market', 'product', 'development', 'implementation', 'solution'
            ]
            ...
            logger.error(f"Failed to get conversation summary {conversation_id}: {e}")
            return {}
