...
class AgentPoolScaler:
    ...
    def __init__(
        self, agent_factory: Dict[str, callable], config: Optional[AgentPoolConfig] = None
    ):
        """
    ...
    def start_scaling(self) -> None:
        ...
        self._monitor_thread = threading.Thread(
            target=self._monitor_agent_pools, name="AgentPoolScaler-Monitor", daemon=True
        )
    ...
    def _evaluate_pool_scaling(self, agent_type: str) -> None:
        ...
        if (
            ...
            and current_pool_size < self.config.max_agents
        ):
        ...
        # Scale down decision
            ...
            and current_pool_size > self.config.min_agents
        ):
    ...
    def _scale_up_agents(self, agent_type: str, count: int) -> None:
        ...
        try:
            ...
            logger.info(
                f"Scaled UP {agent_type} agents by {count}. "
    ...
    def get_agent(
        self, agent_type: str, preferred_skills: Optional[List[str]] = None
    ) -> Optional[Agent]:
